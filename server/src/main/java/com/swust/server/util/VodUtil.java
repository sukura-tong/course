...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        request.setCateId(1000249954L);
        request.setTemplateGroupId("c6b0598e34773f5e6af12ee9bbc34a50");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI4GCCFG3c9gdZAGk4BEGQ";
        //您的AccessKeySecret
        String accessKeySecret = "NQ2RIeCHaLTqbANKLzhYAa5983pcNX";
